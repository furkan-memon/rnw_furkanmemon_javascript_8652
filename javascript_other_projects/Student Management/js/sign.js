...
SignInform.addEventListener("submit", function (e) {
    ...
    if (email_or_username.value.trim().length == 0) {
        ...
        Saveusername = finduser.Username
        SavePassword = finduser.Password
        SaveEmail = finduser.Email
        SaveKay = finduser.Kay
    ...
    else if (Corrct_password.value != SavePassword) {
  ...
  scriptuser = finduser.UserName;
    scriptemail = finduser.Email;
